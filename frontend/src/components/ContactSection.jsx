...
const ContactSection = () => {
  return (
    <section className="relative py-16 bg-blue-900 text-white p-16 m-24 rounded-3xl">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 bg-white p-8 rounded-xl shadow-lg">
          ...
          <form>
            ...
            <button type="submit" className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg">
              Send Your Inquiry
            </button>
          </form>
        </div>
        ...
        <div className="w-full md:w-1/2 bg-blue-800 p-8 rounded-xl shadow-lg mt-8 md:mt-0 md:ml-6">
          ...
          <div className="absolute top-2 right-2 m-2 transform translate-x-8 -translate-y-8">
              <img src={img} alt="Framed Content" className="w-36 h-36 p-2 shadow-none" />
          </div>
        </div>
        </div>
    </section>
